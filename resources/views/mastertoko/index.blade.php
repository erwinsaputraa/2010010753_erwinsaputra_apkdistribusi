            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="px-6 py-2">Domisili</th>
                        <th class="px-6 py-2">Nomor Telepon</th>
                        <th class="px-6 py-2">Foto Toko</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <th class="px-6 py-2">{{ $index + $pendafoutlite->firstItem() }}</th>
                        {{-- <td class="px-6 py-2">{{ $item->kode }}</td> --}}
                        <td class="px-6 py-2">{{ $item->namatoko }}</td>
                        <td class="px-6 py-2">{{ $item->pemiliktoko }}</td>
