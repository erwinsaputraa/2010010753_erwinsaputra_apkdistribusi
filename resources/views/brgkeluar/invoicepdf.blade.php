        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                @foreach ($query as $item)
                    @php
                        $subTotal = $item->hargabarang * $item->qty;
                        $grandTotal += $subTotal; // Akumulasi grandTotal
                    @endphp
                    <tr>
                        <td>{{ $loop->iteration }}</td>
                        <td class="px-10 py-10">{{ $item->kodebarang }}</td>
                        <td class="px-10 py-10">{{ $item->namabarang }}</td>
                        <td class="px-10 py-10">Rp. {{ number_format($item->hargabarang, 0, ',', '.') }}</td>
                        <td class="px-10 py-10">{{ $item->qty }}</td>
                        <td class="px-10 py-10">Rp. {{ number_format($subTotal, 0, ',', '.') }}</td>
                    </tr>
                @endforeach
